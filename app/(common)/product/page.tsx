        ...
        <div className="lg:col-span-2 bg-customSoftBlue p-6 lg:p-12 flex flex-col items-center justify-center text-center my-6">
          <div className="max-w-2xl space-y-6">
            ...
            <p className="text-textGray ">
              B2B Your Ultimate Destination for Wholesale Product Sourcing.
              Display Your Products and Connect with Buyers in the Wholesale
              Market. Let me know if you&apos;d like further variations!
            </p>
